...
public class MultiDaysData extends AppCompatActivity {
    private static final String appid = "49e205a0f7848605b41aa220e12788f3";
    ProgressDialog dialog;
    ApiInterface apiInterface;
    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    MultiForcastRecycle adapter;
    List<DataList> list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_multi_days_data);
        ...
        call.enqueue(new Callback<GetWeather>() {
            ...
            public void onResponse(Call<GetWeather> call, Response<GetWeather> response) {
              GetWeather body =  response.body();
                if (body != null) {
                    list = body.getList();
                    adapter = new MultiForcastRecycle(list,getApplicationContext());
